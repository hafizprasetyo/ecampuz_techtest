...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 27 Agu 2021 pada 05.25
...
CREATE TABLE `tb_mahasiswa_nilai` (
  `mhs_nilai_id` int(10) UNSIGNED NOT NULL,
  `mhs_id` int(10) UNSIGNED NOT NULL,
...
CREATE TABLE `tb_matakuliah` (
  ...
  `mk_sks` int(10) UNSIGNED NOT NULL,
...
ALTER TABLE `tb_mahasiswa`
  ...
  ADD UNIQUE KEY `mhs_nim` (`mhs_nim`);
...
--
ALTER TABLE `tb_mahasiswa`
  MODIFY `mhs_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT untuk tabel `tb_mahasiswa_nilai`
--
ALTER TABLE `tb_mahasiswa_nilai`
  MODIFY `mhs_nilai_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT untuk tabel `tb_matakuliah`
--
ALTER TABLE `tb_matakuliah`
  MODIFY `mk_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
COMMIT;
